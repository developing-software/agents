<script lang="ts">
  ...
  import ClaudeExecutionViewer from '../viewers/ClaudeExecutionViewer.svelte';
  import CodexExecutionViewer from '../viewers/CodexExecutionViewer.svelte';
  import OpencodeExecutionViewer from '../viewers/OpencodeExecutionViewer.svelte';
