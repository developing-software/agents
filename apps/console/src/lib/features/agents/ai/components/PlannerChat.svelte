<script lang="ts">
	...
	import ToolCard from '$lib/features/agents/ai/components/ToolCard.svelte';
	import ToolOutput from '$lib/features/agents/ai/components/ToolOutput.svelte';
	import TriageResult from '$lib/features/agents/ai/components/TriageResult.svelte';
	import AskUserInput from '$lib/features/agents/ai/components/AskUserInput.svelte';
	import ToolApproval from '$lib/features/agents/ai/components/ToolApproval.svelte';
