...
{#if data.plan}
  {#if data.parentEvent}
    <div class="breadcrumb">
      <a href="/{data.provider}/{data.organization}/{data.repoName}/agents/plans" class="breadcrumb-link">Plans</a>
      <span class="breadcrumb-sep">›</span>
      {#if data.parentEvent.type === 'plan'}
        <a href="/{data.provider}/{data.organization}/{data.repoName}/agents/plans/{data.parentEvent.id}" class="breadcrumb-link">Parent Plan</a>
      {:else}
  ...
  <div class="header">
    <a href="/{data.provider}/{data.organization}/{data.repoName}/agents/plans" class="back">← Plans</a>
    ...
    <div class="header-actions">
      ...
      {/if}
      <a href="/{data.provider}/{data.organization}/{data.repoName}/agents/plans/{data.plan.id}/edit" class="edit-link">Edit</a>
