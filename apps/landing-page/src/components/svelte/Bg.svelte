...
void main() {
  ...
  // Light theme: troughs blend to white and crests to the accent color,
  // so the pattern reads as soft tinted bands instead of near-black.
  vec3 col = mix(vec3(1.0), uColor, pattern);
  col -= (rnd / 15.0 * uNoiseIntensity) * pattern;
