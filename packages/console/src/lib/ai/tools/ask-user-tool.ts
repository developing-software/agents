...
You can include an ASCII diagram or table in the context field to illustrate your question.`,
  inputSchema: z.object({
    ...
    options: z.array(z.string()).optional().describe("Multiple choice options. Omit for free-text answer."),
    context: z.string().optional().describe("Additional context, ASCII diagram, or table to show alongside the question"),
  }),
