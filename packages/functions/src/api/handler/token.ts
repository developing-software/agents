  ...
  export const route = new Hono()
    ...
    .get(
      ...
      validator(
        "param",
        z.object({
          id: Api.Personal.Info.shape.id.meta({
      ...
      async (c) => {
        const data = await Api.Personal.fromID(c.req.valid("param").id);
        if (!data) {
              ...
              "application/json": {
                schema: Result(
                  z.object({
                    ...
                    token: Api.Personal.Info.shape.token.meta({
                      description:
