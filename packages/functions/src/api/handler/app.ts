...
const log = Log.create({ namespace: "api.app" });
...
export namespace AppApi {
  export const route = new Hono()
    ...
    .post(
          ...
          200: {
            content: {
              "application/json": {
                schema: Result(
                  z.object({
                    id: Api.Client.Info.shape.id.meta({
      ...
      validator(
        "json",
        z.object({ name: z.string(), redirectURI: z.string() }).meta({
